...
// CONFIGURATION: Set destination messaging URL here
const CONFIG = {
    MESSENGER_URL: "https://wa.me/5511999999999", // Replace with preferred WhatsApp / Telegram / Messenger link
...
function initActions() {
    ...
    btn.addEventListener('click', () => {
        ...
        // Open direct messenger link
        window.open(CONFIG.MESSENGER_URL, '_blank', 'noopener,noreferrer');
    });
}
